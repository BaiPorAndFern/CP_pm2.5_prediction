...
def home():
    return render_template('home.html', current_page = '/')
...
def prediction():
    return render_template('prediction_v2_20231113.html', current_page = 'prediction')
...
def predict():
    try:
        ...
        message_combine = f"{message} is {prediction:.2f}"
